  ...
  lbs = {
    "lbe_1" = {
      ...
      frontend_ip_configurations = [
        {
          name                 = "lbe_1_fe_1"
          public_ip_address_id = module.module_azurerm_public_ip["pip_lbe_1_fe_1"].public_ip.id
        },
        {
          name                 = "lbe_1_fe_2"
          public_ip_address_id = module.module_azurerm_public_ip["pip_lbe_1_fe_2"].public_ip.id
        }
      ]
    },
    "lbe_2" = {
      ...
      frontend_ip_configurations = [
        {
          name                 = "lbe_2_fe_1"
          public_ip_address_id = module.module_azurerm_public_ip["pip_lbe_2_fe_1"].public_ip.id
        }
      ]
    },
    "lbi_1" = {
      ...
      frontend_ip_configurations = [
        {
          ...
          subnet_id                     = module.module_azurerm_subnet["snet_0"].subnet.id
          vnet_name                     = module.module_azurerm_virtual_network[var.virtual_network_name].virtual_network.name
          private_ip_address            = cidrhost(module.module_azurerm_subnet["snet_0"].subnet.address_prefixes[0], 5)
